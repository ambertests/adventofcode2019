...
class Day02Test extends FunSpec {
  ...
  describe("Array computer"){
    ...
    it("handles array with values beyond 99"){
      assert(Day02.computeArray(Array(2,4,4,5,99,0)) sameElements Array(2,4,4,5,99,9801))
    }
    it("handles array with multiple command sequences"){
      assert(Day02.computeArray(Array(1,1,1,4,99,5,6,0,99)) sameElements Array(30,1,1,4,2,5,6,0,99))
    }
